...
{
    /// <summary>
    /// Implementacja wzorca projektowego builder budującego zbiór wynikowy w formacie txt
    /// </summary>
    public class ResultSetBuilderTxtImpl:IResultSetBuilder

    {
        private string _resultSet;

        public ResultSetBuilderTxtImpl()
        {
